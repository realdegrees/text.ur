...
APP_PATH: Path = Path(__file__).resolve().parent.parent / "app"

print(f"Adding models path to sys.path: {APP_PATH}")
...
if not config.get_main_option("sqlalchemy.url"):
    print("Setting SQLAlchemy URL from environment variables...")
