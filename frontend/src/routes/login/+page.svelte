...
<div class="flex min-h-screen items-center justify-center p-4">
	...
	>
		<div bind:this={innerEl}>
			...
			{#if form?.error}
				<div class="mb-4 rounded border border-red-300 bg-red-100 p-3 text-red-700 dark:border-red-700 dark:bg-red-900/30 dark:text-red-300">
					{form.error}
				</div>
			{/if}

			{#if form?.success}
				<div class="mb-4 rounded border border-green-300 bg-green-100 p-3 text-green-700 dark:border-green-700 dark:bg-green-900/30 dark:text-green-300">
					{form.message}
				</div>
			{/if}
